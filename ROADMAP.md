...
## 🚀 1. Core Optimization: Performance

*We fight software bloat to keep Ottie fast and efficient.*

* [**Memory Footprint Reduction**](https://github.com/jiayaoqijia/ottie/issues/346)
  * **Goal**: Keep the core process lean and efficient.
...
* **Provider**
  * [**Architecture Upgrade**](https://github.com/jiayaoqijia/ottie/issues/283): Refactor from "Vendor-based" to "Protocol-based" classification (e.g., OpenAI-compatible, Ollama-compatible). *(Status: In progress by @Daming, ETA 5 days)*
...
* **Channel**
  ...
  * [**attachment**](https://github.com/jiayaoqijia/ottie/issues/348): Native handling of images, audio, and video attachments.


* **Skill Marketplace**
  * [**Discovery skills**](https://github.com/jiayaoqijia/ottie/issues/287): Implement `find_skill` to automatically discover and install skills from the [GitHub Skills Repo] or other registries.
...
* **Operations**
  * [**MCP Support**](https://github.com/jiayaoqijia/ottie/issues/290): Native support for the **Model Context Protocol (MCP)**.
  * [**Browser Automation**](https://github.com/jiayaoqijia/ottie/issues/293): Headless browser control via CDP (Chrome DevTools Protocol) or ActionBook.
  * [**Mobile Operation**](https://github.com/jiayaoqijia/ottie/issues/292): Android device control (similar to BotDrop).


* **Multi-Agent Collaboration**
  * [**Basic Multi-Agent**](https://github.com/jiayaoqijia/ottie/issues/294) implement
  * [**Model Routing**](https://github.com/jiayaoqijia/ottie/issues/295): "Smart Routing" — dispatch simple tasks to small/local models (fast/cheap) and complex tasks to SOTA models (smart).
  * [**Swarm Mode**](https://github.com/jiayaoqijia/ottie/issues/284): Collaboration between multiple Ottie instances on the same network.
  * [**AIEOS**](https://github.com/jiayaoqijia/ottie/issues/296): Exploring AI-Native Operating System interaction paradigms.
...
* [**QuickGuide (Zero-Config Start)**](https://github.com/jiayaoqijia/ottie/issues/350)
...
* [**Logo Design**](https://github.com/jiayaoqijia/ottie/issues/297): We are looking for a **Mantis Shrimp (Stomatopoda)** logo design!
