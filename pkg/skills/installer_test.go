...
func TestParseGitHubRef(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			repo:         "jiayaoqijia/ottie",
			wantOwner:    "jiayaoqijia",
			wantRepoName: "ottie",
			wantRef:      "main",
			wantSubPath:  "",
		},
		{
			...
			repo:         "jiayaoqijia/ottie/skills/test",
			wantOwner:    "jiayaoqijia",
			wantRepoName: "ottie",
			wantRef:      "main",
		...
		},
		{
			...
			repo:         "https://github.com/jiayaoqijia/ottie/tree/dev/skills/test",
			wantOwner:    "jiayaoqijia",
			wantRepoName: "ottie",
			wantRef:      "dev",
			wantSubPath:  "skills/test",
		},
		{
			...
			repo:         "https://github.com/jiayaoqijia/ottie/blob/main/README.md",
			wantOwner:    "jiayaoqijia",
			wantRepoName: "ottie",
			wantRef:      "main",
		...
		},
		{
			...
			repo:           "https://github.com/jiayaoqijia",
			wantErr:        true,
...
func TestSkillInstaller_InstallFromGitHub_SkillAlreadyExists(t *testing.T) {
	...
	existingSkill := filepath.Join(skillsDir, "ottie")
	...
	err = installer.InstallFromGitHub(context.Background(), "jiayaoqijia/ottie")
	if err == nil {
