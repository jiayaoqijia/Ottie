...
func TestResolveWorkspace(t *testing.T) {
	result := ResolveWorkspace("/home/user/.ottie")
	assert.Equal(t, "/home/user/.ottie/workspace", result)
}

func TestRelPath(t *testing.T) {
	result := RelPath("/home/user/.ottie/workspace/file.txt", "/home/user/.ottie")
...
func TestResolveTargetHome(t *testing.T) {
	...
	require.NoError(t, err)
	assert.Equal(t, filepath.Join(home, ".ottie"), result)
}
