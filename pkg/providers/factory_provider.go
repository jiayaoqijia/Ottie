...
import (
	...
	anthropicmessages "github.com/jiayaoqijia/ottie/pkg/providers/anthropic_messages"
)
...
func createClaudeAuthProvider() (LLMProvider, error) {
	...
	if cred == nil {
		return nil, fmt.Errorf("no credentials for anthropic. Run: ottie auth login --provider anthropic")
	}
...
func createCodexAuthProvider() (LLMProvider, error) {
	...
	if cred == nil {
		return nil, fmt.Errorf("no credentials for openai. Run: ottie auth login --provider openai")
	}
