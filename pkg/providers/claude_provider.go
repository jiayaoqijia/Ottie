...
import (
	...
	anthropicprovider "github.com/jiayaoqijia/ottie/pkg/providers/anthropic"
)
...
func createClaudeTokenSource() func() (string, error) {
	return func() (string, error) {
		...
		if cred == nil {
			return "", fmt.Errorf("no credentials for anthropic. Run: ottie auth login --provider anthropic")
		}
