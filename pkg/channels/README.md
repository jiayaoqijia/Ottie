# Ottie Channel System: Complete Development Guide

> **Scope**: `pkg/channels/`, `pkg/bus/`, `pkg/media/`, `pkg/identity/`, `cmd/ottie/internal/gateway/`
...
│   ├── init.go
│   └── discord.go
├── slack/ line/ onebot/ dingtalk/ feishu/ wecom/ qq/ whatsapp/ whatsapp_native/
│   └── ...
...
import (
    "github.com/jiayaoqijia/ottie/pkg/bus"
    "github.com/jiayaoqijia/ottie/pkg/channels"     // Reference parent package
    "github.com/jiayaoqijia/ottie/pkg/config"
    "github.com/jiayaoqijia/ottie/pkg/identity"      // New
    "github.com/jiayaoqijia/ottie/pkg/media"          // New (if media support needed)
)
```
...
```go
// cmd/ottie/internal/gateway/helpers.go
import (
    _ "github.com/jiayaoqijia/ottie/pkg/channels/telegram"   // Triggers init() registration
    _ "github.com/jiayaoqijia/ottie/pkg/channels/discord"
    _ "github.com/jiayaoqijia/ottie/pkg/channels/your_new_channel"  // New addition
)
```
...
import (
    ...
    "github.com/jiayaoqijia/ottie/pkg/channels"
    "github.com/jiayaoqijia/ottie/pkg/config"
    "github.com/jiayaoqijia/ottie/pkg/identity"
...
```go
// If the platform supports sending placeholder messages (e.g. "Pondering..."),
...
// When cfg.Text is empty, channels.RandomThinkingPhrase() returns a varied
// gerund phrase (e.g. "Synthesizing...", "Spelunking...", "Orchestrating...").
func (c *MatrixChannel) SendPlaceholder(ctx context.Context, chatID string) (string, error) {
    ...
    text := cfg.Text
    if text == "" {
        text = channels.RandomThinkingPhrase()
    }
...
// cmd/ottie/internal/gateway/helpers.go
import (
    _ "github.com/jiayaoqijia/ottie/pkg/channels/matrix"
)
```
...
7. **ReasoningChannelID**: Most channel configs include a `reasoning_channel_id` field to route LLM reasoning/thinking output to a designated channel (WhatsApp, Telegram, Feishu, Discord, QQ, DingTalk, Slack, LINE, OneBot, WeCom, WeComApp). `BaseChannel` exposes this via the `WithReasoningChannelID` option and `ReasoningChannelID()` method.