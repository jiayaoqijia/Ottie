...
Examples:
  ottie model                    # Show current default model
  ottie model gpt-5.2           # Set gpt-5.2 as default
  ottie model claude-sonnet-4.6 # Set claude-sonnet-4.6 as default
  ottie model local-model       # Set local VLLM server as default
