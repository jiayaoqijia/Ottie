...
import (
	...
	"github.com/jiayaoqijia/ottie/pkg/migrate"
)
...
func NewMigrateCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "migrate",
		Short: "Migrate from xxxclaw(openclaw, etc.) to ottie",
		Args:  cobra.NoArgs,
		Example: `  ottie migrate
  ottie migrate --from openclaw
  ottie migrate --dry-run
  ottie migrate --refresh
  ottie migrate --force`,
	...
	cmd.Flags().StringVar(&opts.TargetHome, "target-home", "",
		"Override target home directory (default: ~/.ottie)")
