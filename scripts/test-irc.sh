...
CONTAINER_NAME="ottie-test-ergo"
IRC_PORT=6667
...
echo ""
echo "Add this to your ~/.ottie/config.json under \"channels\":"
echo ""
echo '  "irc": {'
echo '    "enabled": true,'
...
echo ""
echo "Then run ottie:"
echo "  cd packages/ottie && go run ./cmd/ottie gateway"
echo ""
...
echo "  Join #test, then: ottiebot: hello"
echo ""
